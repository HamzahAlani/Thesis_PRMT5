...
```{r}
write.csv(significant_motifs_sorted, "MCF10_significant_motifs_sorted.csv", row.names = FALSE)
write.csv(significant_motifs, "MCF10_significant_motifs_only.csv", row.names = FALSE)
write.csv(summary_df, "MCF10_significant_motifs_analysis_summary.csv", row.names = FALSE)
```
