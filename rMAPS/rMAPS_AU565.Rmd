...
```{r}
write.csv(significant_motifs_sorted, "AU565_significant_motifs_sorted.csv", row.names = FALSE)
write.csv(significant_motifs, "AU565_significant_motifs_only.csv", row.names = FALSE)
write.csv(summary_df, "AU565_significant_motifs_analysis_summary.csv", row.names = FALSE)
```
