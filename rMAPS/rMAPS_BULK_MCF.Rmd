...
```{r}
# Testing on a single txt file
print(process_file("MXEpVal.dn.vs.bg.RNAmap.txt"))
```
...
```{r}
write.csv(significant_motifs_sorted, "BULK_significant_motifs_sorted.csv", row.names = FALSE)
write.csv(significant_motifs, "BULK_significant_motifs_only.csv", row.names = FALSE)
write.csv(summary_df, "BULK_significant_motifs_analysis_summary.csv", row.names = FALSE)
```
